 ...
 */
 function wcusage_updated_cache_dismissed() {
     ...
     $current_notice_version = "5.0.0"; // Change this when should show the notice again for sites that update the plugin.
...
function wcusage_updated_cache_notice() {
    ...
    if ( !$notice_dismissed ) {
      ...
      <p>
      Coupon Affiliates <?php echo __( "was updated", "woo-coupon-usage" ); ?>! (<a href="https://roadmap.couponaffiliates.com/updates" target="_blank"><?php echo __( "View Changelog", "woo-coupon-usage" ); ?></a>) - <strong><?php echo __( "Please CLEAR YOUR CACHE to ensure frontend changes are applied.", "woo-coupon-usage" ); ?></strong>
      <input type="submit" value="<?php echo __( "Dismiss Notice", "woo-coupon-usage" ); ?>" style="cursor: pointer;">
      </p>
      </form>
      </div>
